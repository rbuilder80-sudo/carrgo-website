...
function QuoteFields({ destination, sourcePage, origin, suffix }: Omit<Props, 'title'> & { suffix: string }) {
  ...
  return <form action="https://formsubmit.co/support@carrgo.co.uk" method="POST" className="grid gap-2.5">
    ...
    <label className="grid gap-1 text-xs font-bold text-gray-700">Origin<input required name="origin" defaultValue={origin} placeholder="City, country or supplier" className={inputClass} /></label>
