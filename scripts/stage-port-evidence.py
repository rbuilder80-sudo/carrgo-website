...
fallback = '<noscript><main style="max-width:1000px;margin:40px auto;padding:20px;font:16px/1.6 system-ui"><h1>UK &amp; Ireland Port Congestion Tracker</h1><h2>Current congestion measurements are unverified</h2><p>Previous scores, waits, forecasts and generated history are not validated observations. Unknown does not mean normal. Evidence review: 2026-09-07; last verified measurement: unknown. Coverage: 17 ports.</p><h2>Dated operating notices</h2>' + notices + '<p>Confirm current applicability with the operator. Notices do not establish port-wide congestion.</p><table><caption>Port evidence coverage</caption><thead><tr><th>Port</th><th>Metrics</th><th>Review</th></tr></thead><tbody>' + rows + '</tbody></table><h2>Methodology</h2><p>' + html.escape(ledger['methodology']) + '</p><p><a href="/data/port-evidence/2026-09-07.json">Dated evidence JSON</a> | <a href="/resources/uk-port-congestion-report/">Weekly report data warning</a> | <a href="/get-a-quote/">Discuss your shipment</a></p></main></noscript>'
page, count = re.subn(r'<noscript>\s*<div.*?</noscript>', lambda _: fallback, page, count=1, flags=re.S)
